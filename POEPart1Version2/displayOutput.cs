...
namespace POEPart1Version2
{
    ...
    class displayOutput : Expenses // inherits the abstract class --> expenses
    {
        ...
        public void Result()
        {
                ...
                // calling a method inputValues() from UserInput class
                ...
                Console.WriteLine("Available monthly money after all the specified deductions have been made:  R{0} ", availableMoney); // display the avaible money based on which choice does a user made 
                Console.BackgroundColor = ConsoleColor.Black;
                Console.WriteLine("----------------------------------------------------------------------------------------------------------");
